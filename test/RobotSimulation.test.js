...
describe('#RobotSimulation', () => {
  ...
  it('use debug mode to cover everything', () => {
    const robot = new K(geometries[0])
    robot.debug = true
    robot.inverse(1, 1, 1, 0, 0, 0)
    robot.forward(0, 0, 0, 0, 0, 0)

    assert.equal(robot.debug, true)
  })
